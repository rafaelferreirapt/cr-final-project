...
HD_PWD='/media/psf/Home/Development/ect_ua/cr-final-project/Repository/ramANDrom/ramANDrom/ramANDrom.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ramANDrom_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source ramANDrom_wrapper.tcl
