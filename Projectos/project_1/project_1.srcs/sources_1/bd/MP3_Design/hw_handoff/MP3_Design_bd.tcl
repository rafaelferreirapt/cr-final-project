...
CONFIG.NUM_SI {3} \
  ...
  # Create instance: ramANDrom_wrapper_0, and set properties
  set ramANDrom_wrapper_0 [ create_bd_cell -type ip -vlnv user.org:user:ramANDrom_wrapper:1.0 ramANDrom_wrapper_0 ]
