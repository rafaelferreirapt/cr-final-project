...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.IN0_WIDTH {16} CONFIG.IN1_WIDTH {1} CONFIG.NUM_PORTS {6}  ] $xlconcat_0
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins EightDisplayControl32inputs_0/data_in] [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins xlslice_0/Din]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_ports clk] [get_bd_pins EightDisplayControl32inputs_0/clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_Clk_100M/slowest_sync_clk] [get_bd_pins rst_clk/slowest_sync_clk]
