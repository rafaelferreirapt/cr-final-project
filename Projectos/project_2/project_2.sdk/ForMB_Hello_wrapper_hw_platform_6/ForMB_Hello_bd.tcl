...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.L {128} CONFIG.M {16}  ] $IterativeSorterFSM_0

  # Create instance: TopUnr_0, and set properties
  set TopUnr_0 [ create_bd_cell -type ip -vlnv ua.pt:user:TopUnr:1.0 TopUnr_0 ]
  set_property -dict [ list CONFIG.address_bits {7} CONFIG.data_width {16}  ] $TopUnr_0
  ...
  set_property -dict [ list CONFIG.address_bits {7} CONFIG.data_width {16}  ] $Unroll_ROM_last_0

  # Create instance: axi_gpio_0, and set properties
  set axi_gpio_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_0 ]
  set_property -dict [ list CONFIG.C_ALL_INPUTS_2 {1} CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_DOUT_DEFAULT {0xf0f0f0f0} CONFIG.C_GPIO2_WIDTH {21} CONFIG.C_GPIO_WIDTH {32} CONFIG.C_IS_DUAL {1}  ] $axi_gpio_0
  ...
  set_property -dict [ list CONFIG.IN0_WIDTH {16} CONFIG.IN1_WIDTH {1} CONFIG.IN6_WIDTH {8} CONFIG.NUM_PORTS {6}  ] $xlconcat_0
  ...
  set_property -dict [ list CONFIG.IN0_WIDTH {7} CONFIG.IN1_WIDTH {1}  ] $xlconcat_3
  ...
  set_property -dict [ list CONFIG.IN0_WIDTH {8} CONFIG.IN1_WIDTH {8}  ] $xlconcat_4
  ...
  set_property -dict [ list CONFIG.IN0_WIDTH {4} CONFIG.IN1_WIDTH {4} CONFIG.IN2_WIDTH {4} CONFIG.IN3_WIDTH {4} CONFIG.NUM_PORTS {4}  ] $xlconcat_5
  ...
  set_property -dict [ list CONFIG.CONST_VAL {0} CONFIG.CONST_WIDTH {8}  ] $xlconstant_3

  # Create instance: xlslice_0, and set properties
  set xlslice_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_0 ]
  set_property -dict [ list CONFIG.DIN_FROM {6} CONFIG.DIN_WIDTH {8} CONFIG.DOUT_WIDTH {7}  ] $xlslice_0
  ...
  set_property -dict [ list CONFIG.DIN_FROM {30} CONFIG.DIN_TO {30} CONFIG.DOUT_WIDTH {1}  ] $xlslice_7

  # Create instance: xlslice_8, and set properties
  set xlslice_8 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 xlslice_8 ]
  set_property -dict [ list CONFIG.DIN_FROM {29} CONFIG.DIN_TO {29} CONFIG.DOUT_WIDTH {1}  ] $xlslice_8
  ...
  connect_bd_net -net BinToBCD16_1_BCD0 [get_bd_pins BinToBCD16_1/BCD0] [get_bd_pins xlconcat_5/In0]
  connect_bd_net -net BinToBCD16_1_BCD1 [get_bd_pins BinToBCD16_1/BCD1] [get_bd_pins xlconcat_5/In1]
  connect_bd_net -net BinToBCD16_1_BCD2 [get_bd_pins BinToBCD16_1/BCD2] [get_bd_pins xlconcat_5/In2]
  connect_bd_net -net BinToBCD16_1_BCD3 [get_bd_pins BinToBCD16_1/BCD3] [get_bd_pins xlconcat_5/In3]
  ...
  connect_bd_net -net IterativeSorterFSM_0_data_out [get_bd_pins IterativeSorterFSM_0/data_out] [get_bd_pins TopUnr_0/data_in]
  connect_bd_net -net IterativeSorterFSM_0_led [get_bd_ports led] [get_bd_pins IterativeSorterFSM_0/led] [get_bd_pins xlconcat_4/In0]
  connect_bd_net -net TopUnr_0_data_out [get_bd_pins BinToBCD16_0/binary] [get_bd_pins TopUnr_0/data_out] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net Unroll_ROM_last_0_addr [get_bd_pins Unroll_ROM_last_0/addr] [get_bd_pins xlconcat_3/In0]
  connect_bd_net -net Unroll_ROM_last_0_data_out [get_bd_pins IterativeSorterFSM_0/data_in] [get_bd_pins Unroll_ROM_last_0/data_out]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_4/Din] [get_bd_pins xlslice_5/Din] [get_bd_pins xlslice_7/Din] [get_bd_pins xlslice_8/Din]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_ports clk] [get_bd_pins BinToBCD16_0/clk] [get_bd_pins BinToBCD16_1/clk] [get_bd_pins EightDisplayControl32inputs_0/clk] [get_bd_pins IterativeSorterFSM_0/clk] [get_bd_pins Unroll_ROM_last_0/clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins blk_mem_gen_0/clkb] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_Clk_100M/slowest_sync_clk] [get_bd_pins rst_clk/slowest_sync_clk]
  ...
  connect_bd_net -net xlconcat_4_dout [get_bd_pins BinToBCD16_1/binary] [get_bd_pins xlconcat_4/dout]
  connect_bd_net -net xlconcat_5_dout [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconcat_5/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins BinToBCD16_0/reset] [get_bd_pins BinToBCD16_1/reset] [get_bd_pins xlconstant_0/dout]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins xlconcat_3/In1] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins xlconcat_4/In1] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins TopUnr_0/addr_in] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins blk_mem_gen_0/dina] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins blk_mem_gen_0/addra] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins blk_mem_gen_0/wea] [get_bd_pins xlslice_4/Dout]
  connect_bd_net -net xlslice_7_Dout [get_bd_pins Unroll_ROM_last_0/rst] [get_bd_pins xlslice_7/Dout]
  connect_bd_net -net xlslice_8_Dout [get_bd_pins IterativeSorterFSM_0/reset] [get_bd_pins xlslice_8/Dout]
